    ...
    <motion.div className="group relative overflow-hidden rounded-xl border bg-card transition-all duration-300 hover:shadow-lg">
      ...
      <div className="p-2 sm:p-4">
        ...
        <div className="flex flex-wrap gap-1 mt-1">
          {product.branch && (
            <span className="bg-purple-50 text-purple-700 border border-purple-100 rounded px-2 py-0.5 text-xs font-medium">
              {product.branch.name}
            </span>
          )}
          {product.street && (
            <span className="bg-green-50 text-green-700 border border-green-100 rounded px-2 py-0.5 text-xs font-medium">
              {product.street.name}
            </span>
          )}
          {product.region && (
            <span className="bg-blue-50 text-blue-700 border border-blue-100 rounded px-2 py-0.5 text-xs font-medium">
              {product.region.name}
            </span>
          )}
        </div>
